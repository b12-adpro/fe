...
import { useAuth } from "@/contexts/AuthContext" // Pastikan path import benar
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              {isAuthenticated && !isAdmin && (
                <>
                  <Link href="/donation/campaigns" className="text-gray-700 hover:bg-green-500 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                    Make a Donation
                  </Link>
                  ...
                  <Link href="/profile" className="text-gray-700 hover:bg-green-500 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                    My Profile
                  </Link>
                </>
              )}
              ...
              {isAuthenticated && isAdmin && (
                <>
                  <Link href="/admin/dashboard" className="text-blue-700 hover:bg-blue-500 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                    Admin Dashboard
                  </Link>
                  <Link href="/admin/campaign" className="text-blue-700 hover:bg-blue-500 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                    Manage Campaigns
                  </Link>
                  <Link href="/admin/donation" className="text-blue-700 hover:bg-blue-500 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                    Manage Donations
                  </Link>
                  <Link href="/admin/users" className="text-blue-700 hover:bg-blue-500 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                    Manage Users
                  </Link>
              ...
              {showLoadingState ? (
                ...
                <>
                  ...
                  <span className="text-gray-700 mr-4">
                    Hi, {user?.fullName || user?.username || "User"}! {isAdmin && <span className="text-sm text-blue-600">(Admin)</span>}
                  </span>
                  <button
                    onClick={logout}
